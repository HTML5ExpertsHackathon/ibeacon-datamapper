	...
	,jsObject: function() {
		try {
			...
			if( js.Boot.__instanceof(msg,String) ) {
				haxe.Log.trace(msg,{ fileName : "BeaconData.hx", lineNumber : 34, className : "models.BeaconData", methodName : "jsObject"});
...
models.Person.prototype = {
	...
	,jsObject: function() {
		try {
			...
			if( js.Boot.__instanceof(msg,String) ) {
				haxe.Log.trace("catch error in person",{ fileName : "Person.hx", lineNumber : 50, className : "models.Person", methodName : "jsObject"});
				haxe.Log.trace(this._id,{ fileName : "Person.hx", lineNumber : 51, className : "models.Person", methodName : "jsObject"});
			} else throw(msg);
		}
		return null;
	}
